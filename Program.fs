...
let mostrarEstadisticas (texto: string) =
    printfn "Análisis del texto:"
    printfn "Número de palabras: %d" (contarPalabras texto)
    printfn "Número de líneas: %d" (contarLineas texto)
    printfn "Número de letras: %d" (contarLetras texto)
